create table DKVerwaltung (Datum TEXT, DKNr TEXT, Vorname TEXT, Name TEXT, Anrede TEXT, DKNummer TEXT, Straße TEXT, PLZ TEXT, Ort TEXT, Email TEXT, Rueckzahlung TEXT, vorgemerkt TEXT, Betrag REAL TEXT, Zinssatz TEXT, Bemerkung TEXT);
.separator ";"
...
SELECT replace(Zinssatz, '.', ',') from DkBuchungen GROUP BY Zinssatz ORDER BY Zinssatz;
