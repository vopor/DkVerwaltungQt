...
APP_RESOURCES_FILES.files = ./Jahreskontoauszug.html ./Zinsbescheinigung.html ./F13TurleyGmbH2.gif ./sendDKJAKtos.py ./printCommandDescription.sh ./mail-content.txt ./importCsvIntoDkVerwaltungQt.py ./importDKV2IntoDkVerwaltungQt.py ./exportDkVerwaltungQtToCsv.py ./exportDKV2ToCsv.py
